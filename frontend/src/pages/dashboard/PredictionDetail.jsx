...
import {
  ...
  AlertCircle, FileText, Activity, Thermometer
} from 'lucide-react';
...
const PredictionDetail = () => {
  ...
  const handleReview = async (status) => {
    try {
      ...
      alert(`Prediction ${status} successfully`);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className={`px-4 py-2 rounded-full text-sm font-medium ${getStatusColor(prediction.reviewRequest?.status)}`}>
            ...
            <div className="bg-white rounded-xl shadow-md p-4">
              ...
              <div className="space-y-3">
                <button
                  ...
                  disabled={submitting}
                  className="w-full px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center justify-center disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={submitting}
                  className="w-full px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 flex items-center justify-center disabled:opacity-50"
                >
